    ...
    return (
        <ServicesDetailsStyle>
            ...
            <Grid container rowSpacing={2} columnSpacing={{ xs: 1, sm: 2, md: 1 }}>
                    {
                        differentServices.map((oneDifferentService, index)=> <Grid xs={12} md={6}><OneServiceDetails icone={oneDifferentService.icone} title={oneDifferentService.title} detail={oneDifferentService.text}/></Grid>)
                    }
                </Grid>
        </ServicesDetailsStyle>
    );
