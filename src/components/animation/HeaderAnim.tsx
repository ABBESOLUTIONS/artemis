...
function HeaderAnim({children, sx = {}}: Props) {
    const isOffset = useOffSetTop(HeaderConfig.HEIGHT);

    return (
        <HeaderAnimContainer sx={{...sx, ...(isOffset && { backgroundColor: "rgba(255,255,255,0.7)", height: {md: HeaderConfig.HEIGHT}, boxShadow: "rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px"})}}>
            {children}
        </HeaderAnimContainer>
    );
}
